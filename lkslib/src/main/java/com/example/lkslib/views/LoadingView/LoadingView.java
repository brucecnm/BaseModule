package com.example.lkslib.views.LoadingView;
...
import com.example.lkslib.views.LoadingView.animation.FastOutSlowInInterpolator;
...
public class LoadingView extends View {
    ...
    private static final float CENTER_RADIUS = 18f;
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            //    setColor(a.getInt(R.styleable.LoadingView_color, DEFAULT_COLOR));
